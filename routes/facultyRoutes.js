...
const notices = require('../controller/noticeController')
...
router.post('/createnotice', notices.noticecreate);
router.get('/getnotice/:id',notices.getnotice);
router.put("/Updatenotice/:id",notices.updatenotice);
router.delete("/Deletenotice/:id",notices.deletenotice);
